...
to authenticated
using (id = (select auth.uid()) or private.usuario_es_administrador());
...
create policy colecciones_lectura_publica_o_interna
...
create policy categorias_lectura_publica_o_interna
...
create policy categorias_insertar_interna
on public.categorias for insert
to authenticated
with check ((select private.usuario_es_administrador()));
create policy categorias_actualizar_interna
on public.categorias for update
to authenticated
using ((select private.usuario_es_administrador()))
with check ((select private.usuario_es_administrador()));
create policy categorias_eliminar_interna
...
create policy productos_lectura_publica_o_interna
...
create policy productos_insertar_interna
on public.productos for insert
to authenticated
with check ((select private.usuario_es_administrador()));
create policy productos_actualizar_interna
on public.productos for update
to authenticated
using ((select private.usuario_es_administrador()))
with check ((select private.usuario_es_administrador()));
create policy productos_eliminar_interna
...
create policy imagenes_lectura_publica_o_interna
...
create policy imagenes_insertar_interna
on public.imagenes_producto for insert
to authenticated
with check ((select private.usuario_es_administrador()));
create policy imagenes_actualizar_interna
on public.imagenes_producto for update
to authenticated
using ((select private.usuario_es_administrador()))
with check ((select private.usuario_es_administrador()));
create policy imagenes_eliminar_interna
